...
if (custid != undefined)
	refreshCart(custid);
$(
		"#idProvider,#nameProvider,#authorProvider,#publisherProvider,#priceProvider,#purchasesProvider,#imageProvider,#categoryProvider,#subCategoryProvider,#logState,#custId")
		.remove();
var uncat = new Array;
